    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 md:py-24 flex flex-col md:flex-row gap-12 md:gap-24">
        ...
        <header className="md:w-1/3 flex flex-col md:sticky md:top-24 h-fit">
          ...
          >
            Software Engineer seeking 2027 New Grad roles
          </motion.p>
              ...
              {['About', 'Projects', 'Experience', 'Contact'].map((item, i) => (
                ...
                >
                  <a 
                    ...
                    className="text-slate-400 hover:text-sky-400 text-sm font-semibold tracking-widest uppercase flex items-center group transition-colors"
                  >
          ...
          >
            ...
            <a href="https://veerjain123.medium.com/" className="text-slate-400 hover:text-white transition-colors"><FaMedium size={24} /></a>
            <a href="https://linktr.ee/veerjain1" className="text-slate-400 hover:text-white transition-colors"><SiLinktree size={24} /></a>
        ...
        <main className="md:w-2/3">
          ...
          <Section id="projects" title="Projects">
            ...
            <Card 
              ...
              link="https://github.com/veerjain-1/ai-code-review-cli"
            >
              <ul className="list-disc pl-5 space-y-2">
          ...
          <footer className="text-center text-slate-500 text-sm pb-12">
            <p>Designed and built with React, Vite, Tailwind, & Framer Motion.</p>
          </footer>
        </main>
      </div>
    </div>
